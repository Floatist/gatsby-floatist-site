...
leftTitle: Reporting
leftPar: Save time by empowering yacht owners and other stakeholders.
middleTitle: Handle paperwork in-app
middlePar: Customers can sign the contract, upload their licenses and fill the crew list through the mobile app. Have all paperwork stored in a central place.
